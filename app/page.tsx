...
export default function Home() {
  return (
    <div className="font-roboto">
      <main className="">
        <div className=" flex flex-col items-center justify-center gap-4 py-36 px-4 text-center bg-hero bg-cover bg-center text-white bg-black/50 bg-blend-multiply md:bg-fixed">
        ...
        <div className="flex flex-col items-center justify-center gap-4 py-12 px-4 text-center bg-hero bg-cover bg-center text-white bg-black/50 bg-blend-multiply md:bg-fixed">
